...
public enum DirectAssignmentOutcome
{
    ...
    /// <summary>Lottery ran but no slot is free; booking is Waitlisted (promoted when a slot frees up).</summary>
    Waitlisted
}
...
public interface IDirectAssignmentService
{
    ...
    /// Status=Confirmed/ConfirmedAt, or sets Status=Waitlisted when full.
